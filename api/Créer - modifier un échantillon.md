...
| locale                       | Code de la langue utilisée pour les messages d'erreur ou le formatage des dates. Par défaut : fr, sinon 'en'                                                                                  |                                                             |
...
| operation_code               | Code de l'opération d'un protocole de collecte à laquelle rattacher l'échantillon                                                                                                             |                                                             |
...
| composite_parents_uid        | Liste des UID des parents dans le cas d'un échantillon composé, séparés par une virgule                                                                                                       |                                                             |
| composite_parents_identifier | Liste des identifiants métiers des parents dans le cas d'un échantillon composé, séparés par une virgule                                                                                      |                                                             |
| composite_multiple_value     | Quantité enlevée aux parents, dans le cas d'un échantillon composé                                                                                                                            |                                                             |
